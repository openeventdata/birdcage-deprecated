import logging
import time
from petrarch2 import utilities, PETRglobals, PETRreader, petrarch2
from JSONReader import read_json_
...
class EventCoder:
    ...
    def gen_cameo_event(self, jsonString):
        events = read_json_(jsonString)
        if events:
            updated_events = petrarch2.do_coding(events)
